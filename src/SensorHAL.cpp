...
#endif /* CONFIG_ST_HAL_ASM330LHH_ENABLED */
#ifdef CONFIG_ST_HAL_LPS27HHW_ENABLED
	ST_HAL_NEW_SENSOR_SUPPORTED(CONCATENATE_STRING(ST_SENSORS_LIST_47, TEMP_NAME_SUFFIX_IIO), SENSOR_TYPE_TEMPERATURE, DEVICE_IIO_TEMP,"LPS27HHW Temperature Sensor", 0.0f)
#endif /* CONFIG_ST_HAL_LPS27HHW_ENABLED */
